...
public class KnockBack : MonoBehaviour
{
    ...
    public void GetKnockedBack(Transform damageSourse)
    {
        ...
        _knockBackMovingTimer = _knockBackMovingTimerMax; //устаналиваем врем€ отлета на максимальное 
        Vector2 difference = (transform.position - damageSourse.position).normalized * _knockBackForce / _rb.mass; //определ€ем вектор перемещени€ (направление и силу)
